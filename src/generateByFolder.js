...
import { JIRA_PASSWORD, JIRA_USERNAME, JIRA_FOLDER_NAME } from "./utils/constans.js";
import fs from "fs";
...
async function runFolderGeneration() {
  try {
    ...
    console.log(`\n✅ Generated ${tsGeneratedCount} Test Scenario files in yml-ts/\n`);
